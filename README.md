...
The metrics a senior engineer actually asks about — not line counts.

| | |
|---|---|
| **Transcription accuracy** | Self-hosted **GigaAM-v3**: Golos Farfield **WER 3.9%** vs **16.4%** for Whisper large-v3 on Russian — and **+5–17% more words caught** on four of my own reference recordings. Switching the ASR engine was a measured decision, not a vibe. |
